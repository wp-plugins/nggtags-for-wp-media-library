<?php
?>
<div id="nggml-meta-overlay" style="position:fixed;z-index:100000;display:none;">
...
Description:<div class="nggml-meta-overlay-desc" style="border:1px solid black;padding:3px;overflow:auto;min-height:1em;">{{post_content}}</div>
    </script>
</div>
<?php
?>